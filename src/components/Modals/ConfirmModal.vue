<template>
  ...
  >
    <el-form ref="confirmForm" :model="confirmForm" label-position="top">
      <el-form-item
      ...
      >
        <el-row type="flex" justify="space-between">
          <el-col :span="20">
            <el-input v-model="confirmForm.privateKeys[index]" />
          </el-col>
          <el-upload
            action
            :auto-upload="false"
      ...
      <el-form-item class="button-container">
        <el-button class="fullwidth" type="danger" :loading="isSending" @click="onConfirm">Confirm</el-button>
      </el-form-item>
    </el-form>
  </el-dialog>
</template>
...
export default {
  ...
  computed: {
    ...mapGetters(['accountQuorum', 'confirmDialogVisible'])
  },
  methods: {
    ...mapActions(['closeConfirmDialog']),
    ...
    onConfirm () {
      this.closeConfirmDialog(this.confirmForm.privateKeys).finally(() => {
